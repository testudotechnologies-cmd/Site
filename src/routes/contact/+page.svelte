    ...
    <div class="row justify-content-start">
      <div class="col-lg-8 text-start">
        ...
        <p class="lead text-secondary">
          For inquiries regarding partnerships, research collaborations, or defense
          applications, please contact our team.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        ...
        <form>
          ...
          <div class="mb-4">
            <label for="upload" class="form-label fw-semibold">Secure Document Upload (Optional)</label>
            <input id="upload" type="file" class="form-control" accept=".pdf" />
          </div>

          <button class="btn btn-outline-light px-4 py-2 mt-2">Submit Inquiry</button>
        </form>
      </div>
      ...
      <div class="col-lg-5 offset-lg-1">
        ...
        <div class="mb-3">
          ...
          <a href="mailto:contact@testudotech.com" class="text-decoration-none text-secondary">contact@testudotech.com</a>
        </div>

        <div class="mb-3">
          <strong class="d-block text-white">Partnerships</strong>
          <a href="mailto:partners@testudotech.com" class="text-decoration-none text-secondary">partners@testudotech.com</a>
        </div>
